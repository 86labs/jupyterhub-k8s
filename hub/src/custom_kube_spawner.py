...
class CustomKubeSpawner(KubeSpawner):
    ...
    def profile_list(self, spawner):
        ...
        image_options = {
            ...
            "choices": {
                "custom": {
                    "display_name": "Custom Single Server",
                    "kubespawner_override": {
                        "image": "gfeldman8/jupyterhub-k8s-singleuser:latest"
                    },
                },
                "pytorch2": {
                    "display_name": "Python 3 Training Notebook 2",
        ...
        return [
            {
                "display_name": f'Training Env for {user_info.get("name")}',
                "slug": "training-python",
                "default": True,
                "profile_options": {"image": image_options},
            },
            {
                "display_name": f'Prod Env for {user_info.get("name")}',
                "slug": "prod-python",
                "default": False,
            },
        ]
